...
const ALL_MODULES = [
  ...
  { id: 'onss', label: 'ONSS/Dimona/DmfA', icon: '🏛', group: 'Declarations' },
  { id: 'fiscal', label: 'Fiscal', icon: '📊', group: 'Declarations' },
  { id: 'sepa', label: 'SEPA Virements', icon: '💳', group: 'Declarations' },
