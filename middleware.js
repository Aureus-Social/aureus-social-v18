...
export function middleware(request) {
  ...
  const csp = [
    ...
    `connect-src 'self' https://${supabaseHost} wss://${supabaseHost} https://api.anthropic.com https://api.resend.com https://api.github.com https://ipapi.co https://api.ipify.org https://ec.europa.eu https://open.fts.be https://entreprises.api.gouv.be https://api.kbodata.be https://cbsv.economie.fgov.be`,
